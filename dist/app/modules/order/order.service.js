...
const buyCow = (cowId, buyerId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.log('buyer.budget', typeof buyer.budget);
        console.log('sellerId.income', seller === null || seller === void 0 ? void 0 : seller.income);
        console.log('sellerId.income', typeof (seller === null || seller === void 0 ? void 0 : seller.income));
        // console.log('buyer.label', buyer.label)
        // console.log('buyer.label', typeof buyer.label)
